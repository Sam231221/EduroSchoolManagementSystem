...
urlpatterns = [
  ...
  path("userbookings/", login_required(TemplateView.as_view(template_name='dashboard/userbooking.html')), name="userbooking-view"),
  path("usermemberships/", login_required(TemplateView.as_view(template_name='dashboard/usermembership.html')), name="usermembership-view"),
